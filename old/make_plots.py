...
#    
    ...
    axarr[0].plot(tim,rad['Idir'][:,-1]*np.cos(rad['zen'][:]*np.pi/180.),label='DIR',color='r')#,linestyle='',marker='.')
...
if __name__=='__main__':
    ...
    with Dataset(pf+'ps98_GUV_000350_C_20160422.nc','r') as C, Dataset(pf+'ps98_GUV_000350_C_TC_20160422.nc','r') as TC:
